...
* Added new options to allow users to print labels row-wise from left to right or column-wise from top to bottom to customizable functions and shiny app.
