...
field_label(dat = qrlabelr::square_lattice,
            wdt = 5, # label width in inches
            hgt = 2, # label height in inches
            page_wdt = 8.5, # page width in inches
            page_hgt = 11, # page height in inches
            top_mar = 0.75, # top margin in inches
            bot_mar = 0.75, # bottom margin in inches
            left_mar = 1.75, # left margin in inches
            right_mar = 1.75, # right margin in inches
            numrow = 4L, # number of label rows per page
            numcol = 1L, # number of label columns per page
            filename = 'PlotLabel', # name for pdf file to be created
            font_sz = 10, # font size to use
            Treetag = FALSE, # create a regular field plot label
            Trial = 'PYT', # trial name to use
            Year = 2023, # year of experiment
            family = 'sans', # font style to use
            rounded = TRUE, # rounded corners
            IBlock = FALSE, # no iBlock
            get_unique_id = "ruid", # use RUIDS in generating QRcodes
            rname = "AWK", # specify researcher's name
            seed_source = TRUE # seed source included in fieldbook
            seed_source_id = "SEED_SOURCE" # seed source ID in fieldbook
            )
```
